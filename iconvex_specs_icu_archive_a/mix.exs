defmodule IconvexSpecsICUArchiveA.MixProject do
  use Mix.Project
  ...
  def project do
    [
      app: :iconvex_specs_icu_archive_a,
      version: "0.1.0",
      elixir: "~> 1.16",
      description: "ICU historical mapping-table shard A for Iconvex Specs",
  ...
  def application, do: [mod: {Iconvex.Specs.ICUArchiveShardA.Application, []}]
