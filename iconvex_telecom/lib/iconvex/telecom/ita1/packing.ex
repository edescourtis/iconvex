defmodule Iconvex.Telecom.ITA1.Packing do
  @moduledoc "Packs and unpacks consecutive five-bit ITA1 signal units."

  @doc "Packs one-signal-per-octet ITA1 into consecutive five-bit units."
  def pack(units) when is_binary(units), do: pack_units(units, 0, [])

  @doc "Unpacks consecutive five-bit units into one signal per octet."
