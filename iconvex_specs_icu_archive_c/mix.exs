defmodule IconvexSpecsICUArchiveC.MixProject do
  use Mix.Project
  ...
  def project do
    [
      app: :iconvex_specs_icu_archive_c,
      version: "0.1.0",
      elixir: "~> 1.16",
      description: "ICU historical mapping-table shard C for Iconvex Specs",
  ...
  def application, do: [mod: {Iconvex.Specs.ICUArchiveShardC.Application, []}]
