defmodule Iconvex.Specs.MacEsperantoBenchmark do
  @moduledoc false
  ...
  @codec Iconvex.Specs.MacEsperanto
  ...
  def run do
    ...
    IO.puts("schema\ticonvex-mac-esperanto-benchmark\t1")
    ...
    IO.puts(
      "comparator\tgnu-libiconv-1.19\tunavailable\t" <>
        "no MacOS_Esperanto or MacEsperanto codec in default or extra inventories"
    )

    IO.puts("summary\tMACOS_ESPERANTO\t256 unique octets\tall gates passed")
  end
...
Iconvex.Specs.MacEsperantoBenchmark.run()
