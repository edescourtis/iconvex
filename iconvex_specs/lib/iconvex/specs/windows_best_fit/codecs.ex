defmodule Iconvex.Specs.WindowsBestFit.Codecs do
  @moduledoc false
  @path Path.expand("../../../../priv/windows_best_fit_manifest.etf", __DIR__)
...
for entry <- path |> File.read!() |> :erlang.binary_to_term() |> Map.fetch!(:encodings) do
  module = Module.concat(Iconvex.Specs.WindowsBestFit.Codecs, "C#{entry.index}")
