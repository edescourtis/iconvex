defmodule Iconvex.Specs.ISOIRHistoricalGraphic.Codecs do
  @moduledoc false
  @path Path.expand("../../../../priv/iso_ir_historical_graphic_manifest.etf", __DIR__)
...
for entry <- path |> File.read!() |> :erlang.binary_to_term() |> Map.fetch!(:encodings) do
  module = Module.concat(Iconvex.Specs.ISOIRHistoricalGraphic.Codecs, "C#{entry.index}")
