defmodule Iconvex.Specs.ICUMultibyte.Codecs do
  @moduledoc false
  @path Path.expand("../../../../priv/icu_multibyte_manifest.etf", __DIR__)
...
for entry <- path |> File.read!() |> :erlang.binary_to_term() |> Map.fetch!(:encodings) do
  module = Module.concat(Iconvex.Specs.ICUMultibyte.Codecs, "C#{entry.index}")
