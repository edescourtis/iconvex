defmodule Iconvex.Specs.IANAPCLSymbolSets.Codecs do
  @moduledoc false
  @path Path.expand("../../../../priv/iana_pcl_symbol_sets_manifest.etf", __DIR__)
...
for entry <- path |> File.read!() |> :erlang.binary_to_term() |> Map.fetch!(:encodings) do
  module = Module.concat(Iconvex.Specs.IANAPCLSymbolSets.Codecs, "C#{entry.index}")
