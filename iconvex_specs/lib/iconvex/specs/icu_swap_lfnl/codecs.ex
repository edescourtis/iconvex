defmodule Iconvex.Specs.ICUSwapLFNL.Codecs do
  @moduledoc false
  @path Path.expand("../../../../priv/icu_swap_lfnl_manifest.etf", __DIR__)
...
for entry <- path |> File.read!() |> :erlang.binary_to_term() |> Map.fetch!(:encodings) do
  module = Module.concat(Iconvex.Specs.ICUSwapLFNL.Codecs, "C#{entry.index}")
