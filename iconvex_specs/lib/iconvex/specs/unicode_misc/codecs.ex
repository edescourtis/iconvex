defmodule Iconvex.Specs.UnicodeMisc.Codecs do
  @moduledoc false
  @path Path.expand("../../../../priv/unicode_misc_manifest.etf", __DIR__)
...
for entry <- path |> File.read!() |> :erlang.binary_to_term() |> Map.fetch!(:encodings) do
  module = Module.concat(Iconvex.Specs.UnicodeMisc.Codecs, "C#{entry.index}")
