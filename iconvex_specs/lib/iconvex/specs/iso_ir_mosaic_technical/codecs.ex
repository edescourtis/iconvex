defmodule Iconvex.Specs.ISOIRMosaicTechnical.Codecs do
  @moduledoc false
  @path Path.expand("../../../../priv/iso_ir_mosaic_technical_manifest.etf", __DIR__)
...
for entry <- path |> File.read!() |> :erlang.binary_to_term() |> Map.fetch!(:encodings) do
  module = Module.concat(Iconvex.Specs.ISOIRMosaicTechnical.Codecs, "C#{entry.index}")
  ...
  defmodule module do
    ...
    def encode_from_utf8(input),
      do: Iconvex.Specs.CodecSupport.encode_from_utf8(@entry.id, input)
  end
end
