defmodule Iconvex.Specs.ISOIRJISX0213.Codecs do
  @moduledoc false
  @path Path.expand("../../../../priv/iso_ir_jisx0213_manifest.etf", __DIR__)
...
for entry <- path |> File.read!() |> :erlang.binary_to_term() |> Map.fetch!(:encodings) do
  module = Module.concat(Iconvex.Specs.ISOIRJISX0213.Codecs, "C#{entry.index}")
