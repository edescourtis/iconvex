defmodule Iconvex.Specs.UnicodeMappingComponents.Codecs do
  @moduledoc false
  @path Path.expand("../../../../priv/unicode_mapping_components_manifest.etf", __DIR__)
...
for entry <- path |> File.read!() |> :erlang.binary_to_term() |> Map.fetch!(:encodings) do
  module = Module.concat(Iconvex.Specs.UnicodeMappingComponents.Codecs, "C#{entry.index}")
