defmodule Iconvex.Specs.UnicodeLegacyMappings.Codecs do
  @moduledoc false
  @path Path.expand("../../../../priv/unicode_legacy_manifest.etf", __DIR__)
...
for entry <- path |> File.read!() |> :erlang.binary_to_term() |> Map.fetch!(:encodings) do
  module = Module.concat(Iconvex.Specs.UnicodeLegacyMappings.Codecs, "C#{entry.index}")
