defmodule Iconvex.Specs.ISOIRCNS11643.Codecs do
  @moduledoc false
  @path Path.expand("../../../../priv/iso_ir_cns11643_manifest.etf", __DIR__)
...
for entry <- path |> File.read!() |> :erlang.binary_to_term() |> Map.fetch!(:encodings) do
  module = Module.concat(Iconvex.Specs.ISOIRCNS11643.Codecs, "C#{entry.index}")
