defmodule Iconvex.Specs.DotnetXEuropa do
  @moduledoc "Pinned native Elixir implementation of .NET/Windows CP29001 (`x-Europa`)."

  use Iconvex.Codec

  @table_path Path.expand("../../../priv/dotnet_codepages.etf", __DIR__)
  @manifest_path Path.expand("../../../priv/dotnet_codepages_manifest.etf", __DIR__)
  ...
  @impl true
  def canonical_name, do: "x-Europa"

  @impl true
  def aliases, do: ["CP29001", "windows-29001", "Europa"]

  @impl true
  def codec_id, do: :dotnet_x_europa
