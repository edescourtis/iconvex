defmodule Iconvex.Specs.ISOIRModern.Codecs do
  @moduledoc false
  @path Path.expand("../../../../priv/iso_ir_modern_manifest.etf", __DIR__)
...
for entry <- path |> File.read!() |> :erlang.binary_to_term() |> Map.fetch!(:encodings) do
  module = Module.concat(Iconvex.Specs.ISOIRModern.Codecs, "C#{entry.index}")
